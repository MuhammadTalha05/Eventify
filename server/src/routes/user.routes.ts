...
router.get("/all", requireAuth, requireRole("ADMIN"), ctrl.getAllUsersController);

// Chnage User Role
router.patch("/profile/role", requireAuth, requireRole("ADMIN"), ctrl.changeUserRoleController);
